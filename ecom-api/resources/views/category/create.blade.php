...
@section('dashboard-content')
    ...
    <form action="{{ URL::to('post-category-form') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Merchandising Keyword" name="merchandisingKeyword">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" name="isTopBanner"/>
        </div>
